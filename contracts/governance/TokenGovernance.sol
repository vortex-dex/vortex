...
/// @notice Contract is used to allow anyone to add new ERC20 tokens to vengine given sufficient payment
contract TokenGovernance {
    ...
    /// @notice Token used to collect listing fee for addition of new token to vengine network
    ...
    constructor(
        ...
        // We add vengine governor as a first token lister.
        tokenLister[governor] = true;
        emit TokenListerUpdate(governor, true);
    }

    /// @notice Adds new ERC20 token to vengine network.
    ...
    /// Governance functions (this contract is governed by vengine governor)

    /// @notice Set new listing token and fee
    /// @notice Can be called only by vengine governor
