...
contract VengineNFTFactory is ERC721, NFTFactory {
    ...
    address private _vengineAddress;
    ...
    constructor(
        ...
        _vengineAddress = vengineAddress;
    }

    function mintNFTFromVengine(
        address creator,
        address recipient,
        ...
        require(_msgSender() == _vengineAddress, "7a"); // Minting allowed only from vengine
        ...
        emit MintNFTFromVengine(creator, recipient, creatorAccountId, serialId, contentHash, tokenId);
    }
